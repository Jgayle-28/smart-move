    ...
    >
      ...
      >
        <Stack alignItems='center' direction='row' spacing={2} sx={{ mt: 2 }}>
          {task.isSubscribed && (
            <SvgIcon color='action'>{/* <EyeIcon /> */}</SvgIcon>
          )}
          {hasAttachments && (
            <SvgIcon color='action'>{/* <FileCheck03Icon /> */}</SvgIcon>
          )}
          {hasChecklists && (
            <SvgIcon color='action'>{/* <ListIcon /> */}</SvgIcon>
          )}
          {hasComments && (
            <SvgIcon color='action'>{/* <MessageDotsCircleIcon /> */}</SvgIcon>
          )}
        </Stack>
        {hasAssignees && (
          <AvatarGroup max={3}>
